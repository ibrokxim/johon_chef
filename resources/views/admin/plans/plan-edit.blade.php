    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Просмотр тарифа</h1>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        ...
                                        <form class="form-horizontal" action="{{ route('plans_update', [$plan->id]) }}" method="post" enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-form-label">Имя</label>
                                                <div class="col-sm-12">
                                                    <input type="text" name="name" class="form-control" id="name" value="{{ $plan->name }}">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea id="description" class="form-control summernote" name="description">{{ $plan->description ?? ''}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" name="duration" class="form-control" id="price" value="{{ $plan->duration }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" name="price" class="form-control" id="price" value="{{ $plan->price }}">
